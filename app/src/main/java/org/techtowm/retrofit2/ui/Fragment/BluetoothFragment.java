...
public class BluetoothFragment extends ListFragment {
        ...
        discoveryBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (BluetoothAdapter.ACTION_DISCOVERY_FINISHED.equals(intent.getAction())) {
                    scanState = ScanState.DISCOVERY_FINISHED; // STOP DISCOVERY
                    stopScan();
                }
            }
        };
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listAdapter = new ArrayAdapter<BluetoothDevice>(getActivity(), 0, listItems) {
            ...
            public View getView(int position, View view, @NonNull ViewGroup parent) {
                ...
                if (view == null) {
                    view = getActivity().getLayoutInflater().inflate(R.layout.fragment_bluetooth, parent, false);
                }
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        inflater.inflate(R.menu.bluetoothfragment_top_app_bar, menu);
    ...
    public void onResume() {
        ...
        if (bluetoothAdapter == null) {
            setEmptyText("[BLE 사용 불가능]");
        } else if (!bluetoothAdapter.isEnabled()) {
            setEmptyText("[블루투스 사용 불가능]");
    ...
    public void onListItemClick(@NonNull ListView l, @NonNull View v,
        ...
        result.putString("MyString", device.getName());
        getParentFragmentManager().setFragmentResult("requestKey", result);
        Toast.makeText(getContext(), device.getName() + " 와 연결 중입니다." , Toast.LENGTH_SHORT).show();
    }
