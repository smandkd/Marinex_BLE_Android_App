...
public class SerialSocket extends BluetoothGattCallback {
    ...
    private static final UUID BLUETOOTH_LE_CUSTOM = UUID.fromString("0000fff0-0000-1000-8000-00805f9b34fb");
    private static final UUID BLUETOOTH_LE_CUSTOM_RW = UUID.fromString("0000fff7-0000-1000-8000-00805f9b34fb");
    private static final UUID BLUETOOTH_LE_CUSTOM_WR = UUID.fromString("0000fff7-0000-1000-8000-00805f9b34fb");
    ...
    private void connectCharacteristics1(BluetoothGatt gatt) {
        ...
        for (BluetoothGattService gattService : gatt.getServices()) {
            if (gattService.getUuid().equals(BLUETOOTH_LE_CUSTOM))
                delegate = new BluetoothLECustom();
    ...
    private class BluetoothLECustom extends DeviceDelegate {
        @Override
        boolean connectCharacteristics(BluetoothGattService gattService) {
            Log.d(TAG, "service BluetoothLECustom uart");
            readCharacteristic = gattService.getCharacteristic(BLUETOOTH_LE_CUSTOM_RW);
            writeCharacteristic = gattService.getCharacteristic(BLUETOOTH_LE_CUSTOM_WR);
            return true;
        }
    }
